...
void test_word()
{
	...
	Word word1 = word; //default memberwise initialization, and it`s completed by bitwise copy semantics(shallow copy),it will invoke mistake
	...
	Word word2("def");
  	...
  	//this is assignment
	word2 = word;//there will use deep copy if the class Word does not have a expilcit deep copy,or it will be bitwise copy ,and then invoke mistake
	cout << "word.str_=" << (int*)word.str_ << endl;
